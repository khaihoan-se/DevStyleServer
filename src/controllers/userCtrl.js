...
const userCtrl = {
    register: async (req, res) => {
        try {
            ...
            if(!validatePassword(password)) return res.status(400).json({msg: "Minimum of eight characters, at least one uppercase, one lowercase and one special character."})
